            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  Text('Log in to your S04 fan account',
                  ...
                  Row(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text('or', style: AppText.body3Regular),
                      ),
                      const Expanded(child: Divider(color: AppColors.borderLightest)),
                    ],
                  ),
                  const SizedBox(height: 16),
                  SecondaryButton('Continue with Face ID', onTap: () => _enter(context)),
                ],
              ),
            ),
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Text("Don't have an account? ", style: AppText.body2.copyWith(color: AppColors.textLight)),
                  GestureDetector(
