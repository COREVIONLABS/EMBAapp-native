...
class _FanPollsScreenState extends State<FanPollsScreen> {
  static const _polls = <_Poll>[
    ...
    _Poll('Tormusik nach jedem Tor', 'FC Schalke 04', 'Matchday', Icons.music_note_rounded, [Color(0xFFB54708), Color(0xFF7A2E00)],
        ['Tage wie diese', 'Königsblauer S04', 'Sweet Caroline'], [39, 44, 17], Duration(hours: 18, minutes: 40), 20, participants: 15240),
    _Poll('Design des Fanbus 25/26', 'FC Schalke 04', 'Fun', Icons.directions_bus_rounded, [Color(0xFF0A2A5E), Color(0xFF00122B)],
        ['Königsblau Classic', 'Ultras-Graffiti', 'Legenden-Wrap'], [31, 34, 35], Duration(days: 4, hours: 6), 25, participants: 9330),
    ...
    _Poll('Einlauf-Song am Heimspiel', 'Nordkurve', 'Matchday', Icons.queue_music_rounded, [Color(0xFF00695C), Color(0xFF003D33)],
