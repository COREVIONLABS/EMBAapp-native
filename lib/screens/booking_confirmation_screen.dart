    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(children: [
          ...
          Text('Booking Confirmed!', style: AppText.h4),
          ...
          const Spacer(),
          Padding(padding: const EdgeInsets.all(20), child: PrimaryButton('Done', onTap: () => Navigator.of(context).popUntil((r) => r.isFirst))),
          const HomeIndicator(),
        ]),
      ),
    );
