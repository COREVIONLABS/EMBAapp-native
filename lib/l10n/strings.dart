...
const Map<String, String> _de = {
  ...
  // ── Tombola (monthly raffle) ──
  'monthly raffle': 'Monatsverlosung',
  'prizes to win': 'Preise zu gewinnen',
  'prizes': 'Preise',
  'Prizes in': 'Gewinne im',
  'Special raffles': 'Sonderverlosungen',
  'Special raffle': 'Sonderverlosung',
  'Raise your chance': 'Gewinnchance erhöhen',
  'More lots, higher chance to win.': 'Mehr Lose, höhere Gewinnchance.',
  'Your lots': 'Deine Lose',
  'Your points': 'Deine Punkte',
  'winners': 'Gewinner',
  'You’re automatically in with your lots — no sign-up needed. More lots, more chances.': 'Mit deinen Losen bist du automatisch dabei — keine Anmeldung nötig. Mehr Lose, mehr Chancen.',
  'View prizes': 'Gewinne ansehen',
  '{n} more chances in the draw': '{n} zusätzliche Chancen in der Ziehung',
  'This pack costs {n} points. Earn or top up to boost your chances.': 'Dieses Paket kostet {n} Punkte. Sammle oder kaufe Punkte, um deine Chancen zu erhöhen.',
  'You now have {n} lots — more lots, more chances.': 'Du hast jetzt {n} Lose — mehr Lose, mehr Chancen.',
  'Lots added! 🎉': 'Lose hinzugefügt! 🎉',
  'Champions League final': 'Champions-League-Finale',
  '2× VIP tickets vs Dortmund': '2× VIP-Tickets gegen Dortmund',
  'S04 fan box': 'S04 Fanbox',
  ...
  'Binding votes are implemented by the club · 1 fan = 1 vote.': 'Bindende Abstimmungen setzt der Verein um · 1 Fan = 1 Stimme.',
  'Binding — will be implemented': 'Bindend — wird umgesetzt',
  'Advisory': 'Beratend',
  'fans': 'Fans',
  'Chosen by the fans': 'Von den Fans gewählt',
  'will be implemented': 'wird umgesetzt',
  'You’re with the majority.': 'Du bist in der Mehrheit.',
  'The majority chose {a}.': 'Die Mehrheit wählte {a}.',
  'Kit': 'Trikot',
  'Squad': 'Kader',
  'Fun': 'Fun',
  // ── Filters / sorting ──
  ...
  'Auctions': 'Auktionen',
  'Auction': 'Auktion',
  'Points auctions': 'Punkte-Auktionen',
  'Bid with points': 'Mit Punkten bieten',
  'Money-can’t-buy items & experiences — win them with your Fan Points.':
      'Unbezahlbare Objekte & Erlebnisse — gewinne sie mit deinen Fan Points.',
  'to bid': 'zum Bieten',
  'You’ve been outbid': 'Du wurdest überboten',
  'bid again to win it back': 'biete erneut und hol es dir zurück',
  'You’re the top bidder on {n} lot(s)': 'Du bist Höchstbietender bei {n} Los(en)',
  'Live now': 'Jetzt live',
  'A bid commits your points. Get outbid and they’re returned — you only spend what you win with.':
      'Ein Gebot bindet deine Punkte. Wirst du überboten, bekommst du sie zurück — du gibst nur aus, womit du gewinnst.',
  'Past auctions': 'Vergangene Auktionen',
  'powered by': 'präsentiert von',
  'Winning bid': 'Siegergebot',
  'Current bid': 'Aktuelles Gebot',
  'You’re winning': 'Du führst',
  'Outbid': 'Überboten',
  'Bid now': 'Jetzt bieten',
  '{n} bids': '{n} Gebote',
  '· {n} bids': '· {n} Gebote',
  'Live auction': 'Live-Auktion',
  'Bid with your Fan Points — win what money can’t buy.':
      'Biete mit deinen Fan Points — gewinne, was man nicht kaufen kann.',
  'Claim your prize': 'Preis einlösen',
  'Auction ended': 'Auktion beendet',
  'Raise your bid': 'Gebot erhöhen',
  'Bid again': 'Erneut bieten',
  'Place a bid': 'Gebot abgeben',
  'Total bids': 'Gebote gesamt',
  'You lead with {n} pts committed': 'Du führst mit {n} Pkt. gebunden',
  'You were outbid — your points were returned': 'Überboten — deine Punkte wurden erstattet',
  'No bid from you yet — the lead is open': 'Noch kein Gebot von dir — die Führung ist offen',
  'Bids commit your points. If someone outbids you, we return them instantly.':
      'Gebote binden deine Punkte. Überbietet dich jemand, erstatten wir sie sofort.',
  'Congratulations — you won this lot! Claim it to get your collection code.':
      'Glückwunsch — du hast dieses Los gewonnen! Einlösen für deinen Abhol-Code.',
  'Demo: let a rival outbid me': 'Demo: von einem Rivalen überbieten lassen',
  'Not enough points': 'Nicht genug Punkte',
  'You need {n} pts to bid. Top up to join the auction?':
      'Du brauchst {n} Pkt. zum Bieten. Aufladen und mitbieten?',
  'You’re the top bidder!': 'Du bist Höchstbietender!',
  'Your bid of {n} pts leads. We’ll alert you the moment someone bids higher.':
      'Dein Gebot über {n} Pkt. führt. Wir melden uns, sobald jemand höher bietet.',
  'Your bid': 'Dein Gebot',
  'min': 'min.',
  'Balance': 'Guthaben',
  'committed': 'gebunden',
  'Confirm bid': 'Gebot bestätigen',
  'Auction win': 'Auktionsgewinn',

  // ── Sponsor missions ─────────────────────────────────────────
  'Sponsor missions': 'Sponsor-Missionen',
  'Our partners reward you': 'Unsere Partner belohnen dich',
  'Complete a partner mission and the sponsor pays you in Fan Points.':
      'Erledige eine Partner-Mission — der Sponsor zahlt dich in Fan Points aus.',
  'to earn right now': 'jetzt verdienbar',
  'Open missions': 'Offene Missionen',
  'Fresh missions drop every week — the more you do, the more the sponsors give back.':
      'Jede Woche neue Missionen — je mehr du machst, desto mehr geben die Sponsoren zurück.',
  'Completed': 'Erledigt',
  'Our partners pay you in points': 'Unsere Partner zahlen dich in Punkten',
  '{n} open missions · watch, survey, scan & more': '{n} offene Missionen · schauen, befragen, scannen & mehr',
  'to earn': 'verdienbar',
  'pts to earn': 'Pkt. verdienbar',
  '+{n} pts to earn': '+{n} Pkt. verdienbar',
  'Watch': 'Ansehen',
  'Survey': 'Umfrage',
  'Quiz': 'Quiz',
  'Scan receipt': 'Kassenbon scannen',
  'You earned {n} points': 'Du hast {n} Punkte verdient',
  'funded this reward — it’s been added to your balance.':
      'hat diese Belohnung finanziert — sie wurde deinem Guthaben gutgeschrieben.',
  'Watching…': 'Läuft…',
  'Playing sponsor clip…': 'Sponsor-Clip läuft…',
  'Thanks for watching!': 'Danke fürs Ansehen!',
  'Question {a} of {b}': 'Frage {a} von {b}',
  'Which away kit colour?': 'Welche Auswärtstrikot-Farbe?',
  'Anthracite': 'Anthrazit',
  'White': 'Weiß',
  'Retro green': 'Retro-Grün',
  'Where do you buy your kit?': 'Wo kaufst du dein Trikot?',
  'Online': 'Online',
  'At the stadium': 'Im Stadion',
  'How often do you buy new kit?': 'Wie oft kaufst du ein neues Trikot?',
  'Every season': 'Jede Saison',
  'Every 2 years': 'Alle 2 Jahre',
  'Rarely': 'Selten',
  'Point the camera at your receipt': 'Richte die Kamera auf deinen Kassenbon',
  'Receipt recognised · €47.80': 'Kassenbon erkannt · 47,80 €',
  'Simulate scan': 'Scan simulieren',
  'Watch the matchday film': 'Sieh den Spieltag-Film',
  'A 30-second Veltins clip on the derby build-up.': 'Ein 30-Sekunden-Veltins-Clip zum Derby-Aufbau.',
  'Watch & earn': 'Ansehen & verdienen',
  'Scan your REWE receipt': 'Scanne deinen REWE-Kassenbon',
  'Shopped at REWE? Scan the receipt to earn.': 'Bei REWE eingekauft? Kassenbon scannen und verdienen.',
  'Scan & earn': 'Scannen & verdienen',
  'Which away kit should we make?': 'Welches Auswärtstrikot sollen wir machen?',
  'Three quick questions — help design next season.': 'Drei kurze Fragen — gestalte die nächste Saison mit.',
  'Take survey': 'Umfrage starten',
  'Share the derby graphic': 'Teile die Derby-Grafik',
  'Spread the blue & white with the Vivawest matchday post.':
      'Verbreite Blau-Weiß mit dem Vivawest-Spieltag-Post.',
  'Share & earn': 'Teilen & verdienen',
  'Knappen quiz': 'Knappen-Quiz',
  'One question. Get it right, earn the points.': 'Eine Frage. Richtig beantworten, Punkte kassieren.',
  'Play quiz': 'Quiz spielen',
  'Sponsor missions ': 'Sponsor-Missionen ',
  'You’re winning a lot': 'Du führst bei einem Los',
  'Bid to win prizes': 'Biete auf Preise',
  ...
  'Dining': 'Gastro',
  'Transport': 'Verkehr',
  'Gelsenkirchen zoo tickets': 'Gelsenkirchen Zoo-Tickets',
  'Cinema tickets on matchdays': 'Kinotickets am Spieltag',
  ...
  '€ value': '€ Wert',
  'Ended': 'Beendet',
  'Priority ticket access to top matches (48–72h)': 'Vorrang-Zugang zu Top-Spielen (48–72 Std)',
  'Yearly': 'Jährlich',
  'Save yearly': 'Jährlich sparen',
  // ── Shared toggle labels & empty states ──
  'No open vouchers': 'Keine offenen Gutscheine',
  'Nothing used yet': 'Noch nichts eingelöst',
  'Redeem points for a voucher to see it here.': 'Löse Punkte für einen Gutschein ein, dann erscheint er hier.',
  'Redeemed vouchers move here once the code is used.': 'Eingelöste Gutscheine landen hier, sobald der Code verwendet wurde.',
  'Earned': 'Verdient',
  'Spent': 'Ausgegeben',
  ...
  'Signed home jersey 25/26': 'Signiertes Heimtrikot 25/26',
  'Match-issued, signed by the full squad': 'Spielausgabe, vom ganzen Team signiert',
  'VIP matchday for two': 'VIP-Spieltag für zwei',
  'Business seats + players’ tunnel walk vs Dortmund': 'Business-Plätze + Spielertunnel-Walk gegen Dortmund',
  'Match-worn derby boots': 'Im Derby getragene Schuhe',
  'Worn & signed — with certificate': 'Getragen & signiert — mit Zertifikat',
  'Legends dinner — one seat': 'Legenden-Dinner — ein Platz',
  'Dine with S04 legends at the VIP lounge': 'Dinner mit S04-Legenden in der VIP-Lounge',
  'From the derby win — whole team signed': 'Vom Derbysieg — vom ganzen Team signiert',
  'Ends in 2d 4h': 'Endet in 2 T 4 Std',
  'Ends in 6h 12m': 'Endet in 6 Std 12 Min',
  'Ends in 1d 9h': 'Endet in 1 T 9 Std',
  'Ends in 3d 1h': 'Endet in 3 T 1 Std',
  'Won — last month': 'Gewonnen — letzten Monat',
  ...
  'Tap the heart on a partner to save it here.': 'Tippe das Herz bei einem Partner, um ihn hier zu merken.',
  'Sponsored': 'Gesponsert',
  'More fast-food offers': 'Mehr Fast-Food-Angebote',
  'All top partners': 'Alle Top-Partner',
  'New partners': 'Neue Partner',
  'Just joined the Fan+ programme.': 'Frisch beim Fan+ Programm dabei.',
  'Nothing new right now': 'Aktuell nichts Neues',
  'Check back soon for new partners.': 'Schau bald wieder für neue Partner vorbei.',
  'partners': 'Partner',
  '{n} offers': '{n} Angebote',
